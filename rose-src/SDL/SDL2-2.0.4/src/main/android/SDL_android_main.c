...
// int Java_com_freeors_kingdom_SDLActivity_nativeInit(JNIEnv* env, jclass cls, jobject array)
int Java_com_freeors_kingdom_SDLActivity_nativeInit(JNIEnv* env, jclass cls, jstring res_dir)
{
	const char* utf8;
