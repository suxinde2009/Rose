...
REGISTER_DIALOG(edit_formula)

tedit_formula::tedit_formula(display& disp)
	: disp_(disp)
{
}

void tedit_formula::pre_show(CVideo& /*video*/, twindow& window)
{
/*
	std::stringstream ss;
	...
	ss.str("");
	ss << "ROW#" << tintegrate::generate_format(u_.get_location().x, "yellow"); 
